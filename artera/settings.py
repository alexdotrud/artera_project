...
# Security settings
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-bf_nx7m0sd(kbofoqv1g*ba))$ux)2(ju#mr-kr5#21@5iql_d')
DEBUG = False
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # Update later for production
